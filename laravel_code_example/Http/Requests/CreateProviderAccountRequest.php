...
class CreateProviderAccountRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            "country" => "required",
            "currency" => "required",
            "wireAccountType" => "required|array|min:1",
            "wireAccountType.*" => "required|string",
            ...
            "minimum_balance_alert" => "nullable|numeric",
    ...
    public function messages()
    {
        return [
            ...
            "name.alpha" => t('provider_field_alpha'),
            ...
            "wireAccountType.required" => t('provider_field_required'),
            ...
            "minimum_balance_alert.numeric" => t('provider_field_integer'),
        ];
    }
